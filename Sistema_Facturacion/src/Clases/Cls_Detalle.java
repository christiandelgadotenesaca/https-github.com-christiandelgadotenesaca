...
public class Cls_Detalle {
    ...
    public Cls_Detalle(int FAC_CODIGO, int PROD_CODIGO,String TRAN_CODIGO, int FAC_CANTIDAD, String FAC_DETALLE, double FAC_V_UNITARIO, double FAC_TOTAL_ITEM) {
    ...
    public void Guardar()
    {
     cnx.ejecutar("Insert Into factura_detalle_tb (FAC_CODIGO,PROD_CODIGO,TRAN_CODIGO,FAC_CANTIDAD,FAC_DETALLE,FAC_V_UNITARIO,FAC_TOTAL_ITEM)values("+FAC_CODIGO+","+PROD_CODIGO+",'"+TRAN_CODIGO+"',"+FAC_CANTIDAD+",'"+FAC_DETALLE+"',"+FAC_V_UNITARIO+","+FAC_TOTAL_ITEM+")");
    } 
